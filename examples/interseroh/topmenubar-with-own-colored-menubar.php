...
<div id="tmb_top_menu_bar" data-tmb-bgcolor="#FF00FF" data-tmb-txtcolor="#7722FF" data-tmb-headline="TEST APPLICATION"
    ...
    <nav class="navbar navbar-default default" role="navigation"
         style="background-color: rgb(255, 0, 255); color: rgb(119, 34, 255); margin-bottom: 0pt;">
        ...
        <div id="icons_right" class="icons-right">
            <button type="button" class="navbar-toggle TMB_application__button headertabs" data-toggle="collapse"
                ...
                <span class="icon-bar"
                      style="background-color: rgb(119, 34, 255);">
                </span>
                <span class="icon-bar"
                      style="background-color: rgb(119, 34, 255);">
                </span>
            ...
            <div id="tmb_app_launcher" data-tmb-javascript-url="/applauncher/applauncher.nocache.js"
                ...
                <li class="dropdown" onclick="showApplauncherPopover();"
                    onfocusout="hideApplauncherPopover();" style="float: right;">
