...
<body>
<div id="tmb_top_menu_bar" data-tmb-headline="TEST APPLICATION" data-tmb-theme="darkblue"
     data-tmb-icon-url="images/logo.svg" class="TMB_application">


    <nav class="navbar navbar-default darkblue" role="navigation" style="margin-bottom: 0pt;">
        <div class="navbar-header">
            <div class="TMB_application__logocontainer"><img src="images/logo.svg"
                                                             class=""></div>
        ...
        <div id="icons_right" class="icons-right">
            <button type="button" class="navbar-toggle TMB_application__button headertabs" data-toggle="collapse"
                    data-target="#tmb_navbar_collapse">
                <span class="icon-bar"
                      style="background-color: rgb(255, 255, 255);">
                </span>
                <span class="icon-bar" style="background-color: rgb(255, 255, 255);">
                </span>
                <span class="icon-bar"
                      style="background-color: rgb(255, 255, 255);">
                </span>
...
<nav id="myNavbar" style="margin-top: 0" class="navbar navbar-default navbar-inverse" role="navigation">
    ...
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#tmb_navbarCollapse">
        ...
        <div class="collapse navbar-collapse" id="tmb_navbarCollapse">
