...
<div id="tmb_top_menu_bar" data-tmb-headline="TEST APPLICATION" data-tmb-theme="darkblue"
    ...
    <nav class="navbar navbar-default darkblue" role="navigation" style="margin-bottom: 0pt;">
        <div class="navbar-header">
            <div class="TMB_application__logocontainer"><img src="images/logo.svg" class=""></div>
        ...
        <div id="icons_right" class="icons-right">
            <button type="button" class="navbar-toggle TMB_application__button headertabs" data-toggle="collapse"
                    data-target="#tmb_navbar_collapse"><span class="icon-bar"
                        ...
                        class="icon-bar" style="background-color: rgb(255, 255, 255);"></span><span class="icon-bar"
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <p>
            <a href="http://www.tutorialrepublic.com" target="_blank" class="btn btn-success btn-lg interseroh-style">Get
                started today</a></p>
    </div>
</div>
</body>