    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
            ...
            <div id="sucessinfo" class="alert alert-info " role="alert" style="display:none;">
                ...
                Ihr Passwort wurde zurückgesetzt, bitte loggen Sie sich neu ein.
            </div>
            <br/>
            <div class="panel-body">
                <form action="/interseroh/index.php" method="post" id="repeatform">
                    <div class="form-group">
                        <label class="control-label required" for="Passwort">Passwort</label>
                        <input autofocus="autofocus" class="form-control" id="Passwort" name="Password"
                               placeholder="Passwort" tabindex="1" type="password" value="" autocomplete="off"/>
                    </div>

                    <div class="form-group">
                        <label class="control-label required" for="Passwordrepeat">Passwort wiederholen</label>
                        <input class="form-control" id="Passwordrepeat" name="Passwordrepeat"
                               placeholder="Passwort wiederholen" tabindex="2" type="password" value=""
                               autocomplete="off"/>
                    </div>
                    <div class="btn-group-bottom pull-right">
                        <button class="btn btn-default" type="reset">Abbrechen</button>
                        <button class="btn btn-icon btn-primary" type="submit" tabindex="3" title="Absenden">
